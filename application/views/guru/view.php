...
<body>
	<div class="container-scroller">
		...
		<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
			<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
				<a class="navbar-brand brand-logo" href="<?= base_url('Guru/halaman'); ?>">
					<img src="<?= base_url('regal-1.0.0')?>/images/Tulisan.png" alt="Logo"
						style="width: 180px; height: 70px; object-fit: contain;">
				</a>
				<a class="navbar-brand brand-logo-mini" href="<?= base_url('Guru/halaman'); ?>">
	...
	<script src="<?= base_url('regal-1.0.0'); ?>/js/halaman.js"></script>
