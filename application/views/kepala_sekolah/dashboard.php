        ...
        <div class="card stat-card h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?= base_url('Kepala_Sekolah/pengumuman') ?>" class="btn btn-sm btn-outline-success">Lihat Semua</a>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-6 mb-2">
                        <a href="<?= base_url('Kepala_Sekolah/profil_sekolah') ?>" class="btn btn-light btn-block text-left py-2">
                            <i class="mdi mdi-school text-success mr-2"></i> Profil Sekolah
                        </a>
                    </div>
                    <div class="col-6 mb-2">
                        <a href="<?= base_url('Kepala_Sekolah/pengumuman') ?>" class="btn btn-light btn-block text-left py-2">
                            <i class="mdi mdi-bullhorn text-info mr-2"></i> Pengumuman
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="<?= base_url('Kepala_Sekolah/galeri') ?>" class="btn btn-light btn-block text-left py-2">
                            <i class="mdi mdi-image-multiple text-warning mr-2"></i> Galeri Foto
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="<?= base_url('Kepala_Sekolah/kontak') ?>" class="btn btn-light btn-block text-left py-2">
                            <i class="mdi mdi-phone-classic text-danger mr-2"></i> Pengaturan Kontak
                        </a>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?= base_url('Kepala_Sekolah/galeri') ?>" class="btn btn-sm btn-outline-success">Lihat Galeri</a>
                </div>
